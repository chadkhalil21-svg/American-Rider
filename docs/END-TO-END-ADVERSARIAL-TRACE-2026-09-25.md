...
3. Party declaration. The Booker states self, another adult, or minor. The server normalizes this declaration. Another-person Travel requires the actual Traveler's name. A minor Travel requires a parent/legal-guardian attestation and records the Booker as guardian; no DOB is collected merely for dispatch.
