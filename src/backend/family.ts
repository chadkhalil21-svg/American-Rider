...
export type FamilyLink={id:string;status:'invited'|'active'|'revoked';role:'guardian'|'teen';guardianName?:string;teenName?:string;eligible:boolean;inviteExpiresAt?:number|null};
