...
const QUALIFIED_USER = (id) => ({ name:id==='opA'?'Nearby N.':'Far F.', stripeAccountId:`acct_${id}`, documents:{ license:DOC('license'), registration:DOC('registration'), insurance:{...DOC('insurance'), evidence:{ isTheRequestedDocument:true, legible:true, fields:{ commercialUse:'yes', liabilityLimit:'$1,000,000' }, insurance:{ namedInsureds:[id==='opA'?'Nearby N.':'Far F.'], vehicles:[{plate:'ABC123'}], effectiveDate:'2025-01-01', expirationDate:'2030-12-31', tncEndorsement:'yes', rideLimits:{combinedSingleLimit:'$1,000,000'}, loggedOnLimits:{bodilyInjuryPerPerson:'$50,000',bodilyInjuryPerIncident:'$100,000',propertyDamage:'$25,000'}, pip:{shown:'yes',amount:'$10,000'}, uninsuredMotorist:{shown:'yes'} } } } }, screening:{ status:'clear', completedAt:NOW } });
const FLEET = {
