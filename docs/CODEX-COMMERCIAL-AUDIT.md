...
9. Smart Travel specifically: test OTP unavailable/none/changed itinerary fixtures, unknown transit fare, first car Travel completion, cancelled first leg, leg-2 authority, Family/Teen party preservation, persisted restart continuation, two-charge preview/actual reconciliation, settlement and receipts. Repeat against at least three synthetic region/feed shapes (single agency, multi-agency, variable/unknown fare) and search for hard-coded Miami-Dade/MDT/Metrorail/Metromover/stop/route assumptions. Geography-specific presentation or fare/transfer policy belongs in region/feed data, never universal Smart Travel logic.
